// Comprehensive Structured Metadata for All 20 Data Science Projects
const PROJECTS_DATA = [
  {
    "id": 1,
  ...
  },
  {
    ...
    "benchmarks": [
      ...
      {
        "model": "Random Forest (Raw Pre-Audit)",
        "prec": "0.732",
        "rec": "0.690",
        "f1": "0.710",
        "auc": "0.865",
      ...
      {
        "model": "Fairness-Calibrated Ensemble",
        "prec": "0.720",
        "rec": "0.678",
        "f1": "0.698",
        "auc": "0.854",
  ...
  },
  {
    ...
    "algorithms": [
      "Spatial Density Ratio",
      "DBSCAN Spatial Clustering",
      "K-Means Regional Hubs"
    ],
    "mathFormulas": [
    ...
    "benchmarks": [
      {
        "model": "Fixed Grid Density Binning",
        "prec": "Low",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Coarse",
      ...
      {
        "model": "K-Means Spatial Centroids",
        "prec": "Moderate",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "0.48 (Silh)",
      ...
      {
        "model": "DBSCAN Outlier Desert Isolation",
        "prec": "High",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "High Precision",
  ...
  },
  {
    ...
    "benchmarks": [
      ...
      {
        "model": "LightGBM Regressor (Champion)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "WAPE: 11.4%",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Historical 20-Day Moving Average",
        "prec": "N/A",
        "rec": "58.2%",
        "f1": "N/A",
        "auc": "RMSE: 0.0412",
      ...
      {
        "model": "GARCH(1,1) Econometric Baseline",
        "prec": "N/A",
        "rec": "71.4%",
        "f1": "N/A",
        "auc": "RMSE: 0.0354",
      ...
      {
        "model": "Sentiment-Augmented LightGBM",
        "prec": "N/A",
        "rec": "88.6%",
        "f1": "N/A",
        "auc": "RMSE: 0.0248",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Framingham Risk Scorecard",
        "prec": "0.385",
        "rec": "0.482",
        "f1": "0.428",
        "auc": "0.741",
  ...
  },
  {
    ...
    "algorithms": [
      "Shannon Entropy",
      "Character TF-IDF",
      "LightGBM @ 99.9% Specificity Cutoff"
    ],
    "mathFormulas": [
    ...
    "benchmarks": [
      ...
      {
        "model": "LightGBM High-Specificity Engine",
        "prec": "0.965",
        "rec": "0.918",
        "f1": "0.941",
        "auc": "0.988",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Flat Cost-Plus Markup (+40%)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Margin: +0.0%",
      ...
      {
        "model": "Linear Demand Regression",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Margin: +4.8%",
      ...
      {
        "model": "Log-Log Econometric Optimizer",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Margin: +14.2%",
  ...
  },
  {
    ...
    "algorithms": [
      ...
      "TF-IDF / Sentence Cosine Similarity",
    ...
    "benchmarks": [
      ...
      {
        "model": "Pure SVD Matrix Factorization",
        "prec": "0.742",
        "rec": "0.000 (Fails)",
        "f1": "N/A",
        "auc": "NDCG: 0.784",
      ...
      {
        "model": "Hybrid SVD + Content Fallback",
        "prec": "0.738",
        "rec": "0.658 (Cold)",
        "f1": "N/A",
        "auc": "NDCG: 0.771",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Linear Degradation Baseline",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "RMSE: 24.8 cyc",
      ...
      {
        "model": "Gradient Boosted Degradation (Champion)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "RMSE: 12.1 cyc",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Tabular-Only Baseline (CatBoost)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "MAPE: 9.4% (R\u00b2: 0.812)",
        "latency": "1.2ms",
        "isChamp": false
      },
      {
        "model": "Vision-Only Baseline (CNN Features)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "MAPE: 14.8% (R\u00b2: 0.584)",
        "latency": "12.4ms",
        "isChamp": false
      },
      {
        "model": "Multi-Modal Late Fusion (Champion)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "MAPE: 4.6% (R\u00b2: 0.948)",
        "latency": "14.1ms",
        "isChamp": true
      }
    ],
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Isolated Tabular XGBoost",
        "prec": "0.684",
        "rec": "0.382",
        "f1": "0.490",
        "auc": "0.742",
      ...
      {
        "model": "Graph Centrality + XGBoost",
        "prec": "0.824",
        "rec": "0.714",
        "f1": "0.765",
        "auc": "0.884",
      ...
      {
        "model": "Relational Graph Neural Network",
        "prec": "0.941",
        "rec": "0.946",
        "f1": "0.943",
        "auc": "0.978",
  ...
  },
  {
    ...
    "algorithms": [
      ...
      "Ragas Triad Auditing (Faithfulness, Relevance, Precision)"
    ],
    "mathFormulas": [
    ...
    "benchmarks": [
      {
        "model": "Naive Dense Vector Retrieval",
        "prec": "0.684",
        "rec": "0.710",
        "f1": "N/A",
        "auc": "Faithful: 0.742",
      ...
      {
        "model": "Hybrid BM25 + Dense Search",
        "prec": "0.821",
        "rec": "0.845",
        "f1": "N/A",
        "auc": "Faithful: 0.865",
      ...
      {
        "model": "Hybrid + Cross-Encoder Auditor (Champion)",
        "prec": "0.942",
        "rec": "0.965",
        "f1": "N/A",
        "auc": "Faithful: 0.978",
    ...
    "simConfig": {
      "defaultQuery": "What was Apple's total net sales in 2023?"
    },
  ...
  },
  {
    ...
    "algorithms": [
      ...
      "Spectral Signature Profiling",
      "Random Forest Semantic Pixel Classifier"
    ],
    "mathFormulas": [
    ...
    "benchmarks": [
      ...
      {
        "model": "Multi-Spectral Ensemble (Champion)",
        "prec": "0.954",
        "rec": "0.948",
        "f1": "0.951",
        "auc": "mIoU: 0.918",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "ResNet-18 (Standard BCE Loss)",
        "prec": "0.712",
        "rec": "0.684",
        "f1": "0.698",
        "auc": "0.812",
      ...
      {
        "model": "DenseNet-121 (Weighted BCE)",
        "prec": "0.784",
        "rec": "0.765",
        "f1": "0.774",
        "auc": "0.854",
      ...
      {
        "model": "DenseNet-121 + Focal Loss + Grad-CAM",
        "prec": "0.872",
        "rec": "0.884",
        "f1": "0.878",
        "auc": "0.902",
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Greedy Nearest Neighbor Heuristic",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Fuel: $14,200 (Delay: 28.5m)",
        "latency": "< 1ms",
        "isChamp": false
      },
      {
        "model": "Genetic Algorithm (Static Re-plan)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Fuel: $11,800 (Delay: 18.2m)",
        "latency": "420ms",
        "isChamp": false
      },
      {
        "model": "Deep Q-Network Agent (Champion)",
        "prec": "N/A",
        "rec": "N/A",
        "f1": "N/A",
        "auc": "Fuel: $9,400 (Delay: 7.4m)",
        "latency": "3.5ms",
        "isChamp": true
      }
    ],
  ...
  },
  {
    ...
    "benchmarks": [
      {
        "model": "Maximum Softmax Probability (MSP)",
        "prec": "0.892",
        "rec": "0.912",
        "f1": "0.902",
        "auc": "OOD AUROC: 0.724",
      ...
      {
        "model": "Temperature Scaled Softmax (ODIN)",
        "prec": "0.904",
        "rec": "0.914",
        "f1": "0.909",
        "auc": "OOD AUROC: 0.835",
      ...
      {
        "model": "Mahalanobis Embedding Scorer (Champion)",
        "prec": "0.935",
        "rec": "0.928",
        "f1": "0.931",
        "auc": "OOD AUROC: 0.962",
    ...
    "simConfig": {
      "defaultQuery": "Tell me a funny joke about robots"
    },
